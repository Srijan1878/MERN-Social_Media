...
useEffect(()=>{console.log(user?user._id:user)
...
const PF=process.env.REACT_APP_PUBLIC_FOLDER;
      ...
      return(
        ...
        <div className="birthdayContainer">
          ...
          <span className="birthdayText"><b>Tapabrata Dutta</b> and <b>two other friends</b> have birthday today</span>
        </div> 
        <div className="ad">
            <a href="https://www.zomato.com" target="_blank" rel="noopener noreferrer">
        <img src={PF+"zomato-logo.png"} alt="" className="rightbarAd" />   
        <span className="AdTitle"><b>Order Food Online</b></span>
        </a>
        </div>
