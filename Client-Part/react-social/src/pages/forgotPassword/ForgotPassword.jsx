  ...
  return (
    <div className="forgotPasswordContainer">
      <div className="forgotPasswordWrapper">
        {/*<h3 className="titleText">Reset your Password</h3>*/}
        <form className="inputFieldsContainer" onSubmit={submitHandler}>
        <label> Email</label>
          <input type="text" className="forgotPasswordInput"  onChange={(e)=>{setEmailText(e.target.value)}} value={emailText}></input>
          <label> New Password</label>
          <input type="password" className="forgotPasswordInput"  onChange={(e)=>{setNewPasswordText(e.target.value)}} value={newPasswordText}></input>
          <label> Confirm New Password</label>
          <input type="password" className="forgotPasswordInput" onChange={(e)=>{setConfirmPasswordText(e.target.value)}} value={confirmPasswordText}></input>
          {showValidation && (
            <span className="warningContainer">
              <WarningIcon style={{color:"red"}} className="warningLogo"/>
           <p className="passwordConflictText">Passwords don't match</p>
            </span>
